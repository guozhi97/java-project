...
public class WXConst {
	...
	public static final String ACCESS_TOKEN_PATH="d:/";
	//消息处理方式为同步处理，即消息发过来后，系统自动马上进行回复
	public static final boolean MSG_SYNC_HANDLE = false;
	
//	Base Information of Testing Account
