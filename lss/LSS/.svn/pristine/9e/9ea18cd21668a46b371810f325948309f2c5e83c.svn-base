...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<script type="text/javascript">
		  function showAddress(){
			...
			function delClick(userName){
   				if(confirm("您确定要删除吗?")){
   					window.location.href="deleteNews?userName="+userName;
   				}
   			}
			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="user-address">
						...
						<ul class="am-avg-sm-1 am-avg-md-3 am-thumbnails">
							...
							<li class="user-addresslist defaultAddr">
								...
								<div class="new-addr-btn">
									<a href="editAddress.jsp" ><i class="am-icon-edit"></i>编辑</a>
									<span class="new-addr-bar">|</span>
									<a href="javascript:void(0);" onclick="delClick(${userName});"><i class="am-icon-trash"></i>删除</a>
								</div>
							</li>
						...
						<input type="button" class="addButton" value="新增地址" onclick="showAddress()">
						<a class="new-abtn-type" data-am-modal="{target: '#doc-modal-1', closeViaDimmer: 0}">添加新地址</a>
						<!--例子-->
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">

							<div id="add-dress" style="display: none">
